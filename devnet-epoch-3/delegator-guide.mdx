...
- **Commission Rate**: Percentage of token rewards kept by operator
...
1. Navigate to the operator pool or your portfolio
2. Click **Withdraw USDC**
3. Confirm the transaction to receive your accrued USDC
